...
<head>
  ...
  <title>{{ config('app.name', 'Montrust') }} | @yield('title')</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <i class="fa fa-paw" class="brand-image img-circle elevation-3" style="opacity: .8"></i>
      <span class="brand-text font-weight-light">{{ config('app.name', 'Montrust') }}</span>
    </a>
